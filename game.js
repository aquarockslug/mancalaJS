...
const playMove = (pocket, player, startingPocketIndex) => {
	...
	const addMarbles = (p) => (playerHome(player) == p.index ? Pocket(p.index, p.count + targetPocket.count, p.home) : p);
...
const drawHomePocket = (pos, count) => {
